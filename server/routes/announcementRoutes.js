...
announcementRouter.get('/private/manage-announcements/:id', checkPermissionToken(['admin', 'manage_announcements']), manageAnnouncements);
announcementRouter.get('/private/manage-announcement/:id', checkPermissionToken(['admin', 'manage_announcements']), manageAnnouncement);
announcementRouter.get('/private/announcements/:id', checkPermissionToken(['user', 'admin', 'manage_announcements']), announcements);
announcementRouter.get('/private/announcement/:id', checkPermissionToken(['user', 'admin']), announcement);
announcementRouter.get('/private/search-announcements/:id', checkPermissionToken(['user', 'admin', 'manage_announcements']), searchAnnouncements);
announcementRouter.get('/private/manage-search-announcements/:id', checkPermissionToken(['admin', 'manage_announcements']), manageSearchAnnouncements);
