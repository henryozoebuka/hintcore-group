...
constitutionRouter.get('/private/manage-constitutions/:id', checkPermissionToken(['admin', 'manage_constitutions']), manageConstitutions);
constitutionRouter.get('/private/manage-constitution/:id', checkPermissionToken(['admin', 'manage_constitutions']), manageConstitution);
constitutionRouter.get('/private/constitutions/:id', checkPermissionToken(['user', 'admin', 'manage_constitutions']), constitutions);
constitutionRouter.get('/private/constitution/:id', checkPermissionToken(['user', 'admin']), constitution);
constitutionRouter.get('/private/search-constitutions/:id', checkPermissionToken(['user', 'admin', 'manage_constitutions']), searchConstitutions);
constitutionRouter.get('/private/manage-search-constitutions/:id', checkPermissionToken(['admin', 'manage_constitutions']), manageSearchConstitutions);
