...
const CreatePayment = ({ navigation }) => {
    ...
    const [data, setData] = useState({ title: '', description: '', amount: '', dueDate: null, published: false, required: false });
    ...
    const handleSubmit = async () => {
        ...
        try {
            setLoading(true);
            const response = await privateAxios.post('/private/create-payment', { ...data, members: selectedUsers, });
                ...
                <View style={[stylesConfig.SETTINGS_STYLES.container, { backgroundColor: colors.background }]}>
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Required toggle */}
                            <Pressable
                                onPress={() => setData((prev) => ({ ...prev, required: !prev.required }))}
                                style={{
                                    flexDirection: "row",
                                    alignItems: "center",
                                    marginBottom: 16,
                            ...
                            >
                                <View
                                    style={{
                                        ...
                                        borderColor: colors.text,
                                        marginRight: 8,
                                        backgroundColor: data.required ? colors.primary : "transparent",
                                    }}
                                />
                                <Text style={{ color: colors.text, fontSize: 16 }}>Required</Text>
                            </Pressable>
                    ...
                    {showMembers && (
                        <View style={{
                            ...
                            {membersLoading ?
                                ...
                                <View style={{ width: '90%', maxHeight: '80%', backgroundColor: colors.secondary, borderRadius: 12, padding: 20 }}>
                                    {/* Title */}
