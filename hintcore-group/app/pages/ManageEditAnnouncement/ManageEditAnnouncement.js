...
const ManageEditAnnouncement = ({ route, navigation }) => {
    ...
    // Fetch the announcement data to pre-fill the form
    useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            setLoading(true);
            const response = await privateAxios.patch(`/private/update-announcement/${id}`, { title, body, published });
...
export default ManageEditAnnouncement;