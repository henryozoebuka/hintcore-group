...
const ManageConstitution = ({ route, navigation }) => {
    ...
    const confirmDeleteAction = async () => {
        try {
            ...
            setNotification({
                visible: true,
                type: 'error',
                message: 'Failed to delete constitution.',
            });
        } finally {
        ...
        <View style={{ flex: 1 }}>
            {loading ?
                ...
                constitution ?
                    <View style={[styles.SETTINGS_STYLES.container, { backgroundColor: colors.background }]}>
                        ...
                        <ScrollView style={{ borderBottomColor: colors.placeholder, borderBottomWidth: .5 }}>
                            <Text style={{ fontSize: 16, color: colors.text, marginVertical: 20 }}>
                                {constitution.body || "No content available."}
                            </Text>
                        </ScrollView>
                        ...
                        <View style={{ marginTop: 20, flexDirection: "row", justifyContent: "space-between" }}>
                            <Pressable
                                ...
                                onPress={() => navigation.navigate("manage-edit-constitution", { id })}
                            >
                        ...
                        <ConfirmDialog
                            ...
                            message="Are you sure you want to delete this constitution?"
                    ...
                    <View style={[styles.SETTINGS_STYLES.container, { backgroundColor: colors.background, justifyContent: 'center', alignItems: 'center' }]}>
                        <Text style={{ color: colors.text }}>Constitution not found.</Text>
                    </View>
            }
            <Footer />
        </View>
...
export default ManageConstitution;