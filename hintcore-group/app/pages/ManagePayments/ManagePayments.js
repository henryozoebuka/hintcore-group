...
const ManagePayments = ({ navigation }) => {
    ...
    const confirmDeleteSelected = () => {
        ...
        Alert.alert("Delete", `Delete ${selectedPayments.length} selected payment(s)?`, [
            { text: "Cancel", style: "cancel" },
            {
                ...
                onPress: async () => {
                    try {
                        await privateAxios.post("/private/delete-payments", { ids: selectedPayments });
                        setSelectedPayments([]);
    ...
    const confirmDeleteSingle = (id) => {
        Alert.alert("Delete", "Delete this payment?", [
            { text: "Cancel", style: "cancel" },
            {
                ...
                onPress: async () => {
                    try {
                        await privateAxios.delete(`/private/delete-payment/${id}`);
                        searchMode ? fetchSearchedPayments(currentPage) : fetchPayments(currentPage);
                    } catch {
